...
date = pd.date_range(begin_date1, end_date1, freq='5D')
...
xtick_pos = np.arange(0, var1.size+1,3)
...
plt.axvline(linewidth=0.75, x=1-1/5, color='b')
plt.axvline(linewidth=0.75, x=32+4/5, color='b')
plt.show()
