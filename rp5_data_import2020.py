...
####
db = pd.read_csv('rp5_09_11_2020!.csv', encoding='utf8')
...
db1.to_csv('rp5_09_11_2020!toMerge.csv', encoding='cp1251')

db = pd.read_csv('Sykt_t_data_cleaned_2019.csv', encoding='cp1251')
db1 = pd.read_csv('rp5_09_11_2020!toMerge.csv', encoding='cp1251')
# db = db.set_index(pd.DatetimeIndex(db['date']))
# print(db)
db = pd.concat([db,db1])
db.set_index('date', inplace=True)
db.sort_index(inplace=True)
db.to_csv('MeteoAndRp5_09_11_2020Merged.csv', encoding='cp1251')
