...
plt.ylim((-5, 5))
locs = [-5, -4, -3, -2, -1.5,  -1, -0.5, 0, 0.5, 1, 1.5, 2, 3, 4, 5]
plt.yticks(locs, fontsize=10)
locs, labels = plt.xticks()
locsint = list(map('{:.0f}'.format, locs))
locs1 = np.append(locs, np.array([1979, 1986, 1987, 2020, 1975, 1985, 1995, 2005, 2015]))

labels = np.append(locsint, np.array([''+'\n' + '-7.33', ''+'\n' + '-6.18', ''+'\n\n' + '-23.5', '2020'+'\n' + '-5.25', 1975, 1985, 1995, 2005, 2015]))
plt.xticks(locs1, labels, fontsize=10)
plt.xlim((1966, 2021))
