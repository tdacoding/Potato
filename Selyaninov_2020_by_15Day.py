...
date = pd.date_range(begin_date1, end_date1, freq='15D')
...
plt.axvline(linewidth=0.75, x=1-11/15, color='b')
plt.axvline(linewidth=0.75, x=11-1/15, color='b')
plt.show()
